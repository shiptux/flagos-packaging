...
| 12 | flagos-ai/libtriton_jit | pr/packaging           | [#24](https://github.com/flagos-ai/libtriton_jit/pull/24)  | **MERGED** 2026-07-13 | into `multi-backend` branch (not master) by tengqm; follow-ups open: #47 (lgtm'd 7-25, pinged to merge), #48/#49 (system-dep packaging fixes), #58/#61/#62 (master: multiarch layout, per-backend packaging, perf) — all CI green, maintainer pinged 2026-08-20 |
